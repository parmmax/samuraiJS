    ...
    return (
        <div className={classes.postWrap}>
            ...
            <div className={classes.btnItems}>
                <div className={classes.likesCounts}>
                    <div className={classes.likesCountsWrap}>{props.likesCounts}</div>
                    <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="heart"
                         className={classes.heart} role="img" xmlns="http://www.w3.org/2000/svg"
                ...
                <div className={classes.btnWrap}>
                    <button className={classes.btnEditRemove} type="button">
                        edit
                    </button>
                    <button className={classes.btnEditRemove} type="button">
                        remove
