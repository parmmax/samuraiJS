            ...
            <Card.Footer className="border-0 bg-white">
                <Row>
                    ...
                    <Col className="col-lg-2 col-sm-5 text-right">
                        <Button disabled type="edit" value="Reset" variant="outline-primary" size="sm" className="">Edit</Button>{' '}
                        <Button disabled type="reset" value="Reset" variant="outline-primary" size="sm" className="">Reset</Button>
                    </Col>
                </Row>
            </Card.Footer>
        </Card >
